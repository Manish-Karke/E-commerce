                        ...
                        <div className="w-[88vw] h-auto">
                            <div
                                ...
                                <div className="flex flex-col gap-2 w-[87%]">
                                    <p className="flex text-lg md:text-2xl gap-3 font-semibold">
                                    ...
                                    <p className="flex text-lg md:text-2xl font-semibold">
                                        Email: {userDetails?.email}
                                    </p>
                                </div>
                                <div className="flex flex-col gap-4 text-white w-[13%] h-full shrink-0 items-center justify-center">
                                    {userDetails?.isBan ?
                                        <FaUserLargeSlash size={30} className="bg-blue-800 rounded-md w-[10vw] h-[10vw] p-2" />
                                        :
                                        <FaUserLarge size={30} className="bg-blue-800 rounded-md w-[10vw] h-[10vw] p-2" />
                                    }
                                </div>
                            </div>
                            <div className="flex gap-3 items-center justify-center h-[7vh] w-full shrink-0">
                                {userDetails?.role === 'customer' ? customerTabs.map((tab) => (
                                    <button
                                        ...
                                        className={`flex border border-violet-300 p-2 w-[30%] items-center justify-center rounded-xl header-title h-[5vh] text-lg md:text-2xl 
                                ...
                                <div className="shrink-0 flex flex-col border border-gray-300 h-auto w-full rounded-md p-5 space-y-5 bg-white shadow-sm text-justify">
                                    ...
                                    {userDetails?.role === 'seller' &&
                                        <>
                                            ...
                                            <div>
                                                <h1 className="text-lg md:text-2xl font-semibold text-gray-800 mb-3 flex items-center gap-2">
                                                    <AiOutlineShop />
                                                    Seller Profile
                                                </h1>
                            ...
                            {activeTab === 'products' &&
                                <>
                                    <div className="flex flex-col w-full items-center justify-center p-2 rounded-md gap-3">
                                        {sellerProduct?.data.map((items, index) => (
                                            <div key={index} className="border rounded-xl p-2 border-violet-300">
                                                <div className="flex flex-col w-90 h-[45vh] gap-2  rounded-xl border-gray-500 mb-4 bg-gray-200 relative">
                                                    ...
                                                    <div className="flex w-full h-[5vh]">
                                                        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full bg-green-100 flex flex-col text-2xl px-10 rounded-xl font-semibold text-black h-[5vh] overflow-hidden z-2 p-2 header-title">
                            ...
                            {activeTab === 'reviews' &&
                                <>
                                    <div className="flex flex-col w-full items-center justify-center bg-black/20 p-2 rounded-md">
                                        <div className="flex flex-col w-90 h-[45vh] gap-2  rounded-xl border-gray-500 mb-4 bg-gray-200 relative">
                                            <div className="aboslute flex w-full h-full place-items-center items-center justify-center">
                                                <img
                                            ...
                                            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex w-[50vw] items-center justify-center z-2 ">
                                                <button
                                                    ...
                                                    className="flex w-full border-gray-400 bg-gray-100 border-2 text-xl rounded-xl p-2 font-semibold items-center justify-center transition-all duration-500 h-[6vh]">
                                                    <h3>View Review</h3>
                                                </button>
                                            </div>
                                        </div>
