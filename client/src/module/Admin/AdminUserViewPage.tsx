...
const AdminUserViewPage = () => {
    ...
    return (
        <>
            {!isLoading &&
                <>
                    <div className="flex flex-col w-full h-full bg-gray-50 rounded-md shirnk-0 p-2 gap-4">
                        <div
                            ...
                            <div className="flex flex-col gap-2 w-[87%]">
                                <p className="flex text-lg gap-3 font-semibold">
                        ...
                        <div className="flex gap-3 items-center justify-center h-[7vh] w-full shrink-0">
                            {userDetails?.role === 'customer' ? customerTabs.map((tab) => (
                                <button
                                    ...
                                    className={`flex border border-violet-300 p-2 w-[30%] items-center justify-center rounded-xl header-title h-[5vh] text-lg 
