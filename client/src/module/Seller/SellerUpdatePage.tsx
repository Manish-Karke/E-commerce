            ...
            <form onSubmit={handleSubmit(() => onSubmit(id!))} className="flex w-full h-auto">
                <div className="flex flex-col gap-5 w-full h-auto">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        {!isSubmitting &&
                            <button type="submit" className="flex w-full bg-green-950 shrink-0 text-white header-title items-center justify-center rounded-md h-[6vh]">
                                UPDATE PRODUCT
                            </button>
                        }
                        {isSubmitting &&
                        ...
                        <button onClick={() => navigate('/seller/product')} className="flex w-full bg-gray-500 h-[6vh] text-white header-title items-center justify-center rounded-md">
                            CANCEL UPDATE
                        </button>
                    </div>
                </div>
